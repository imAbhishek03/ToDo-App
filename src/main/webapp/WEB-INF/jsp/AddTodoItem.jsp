...
<div class="container">
    ...
    <form:form action="/save-todo" method="post" modelAttribute="todo">
        ...
        <div class="form-group">
            ...
            <form:input type="text" path="status" id="status" class="form-control" value="Pending" style="display: none;"/>
        </div>
